...
export const ordersTranslations: { [key: string]: OrdersTranslations } = {
  ko: {
    ...
    cancel: "취소",
    cancelOrder: "주문 취소",
    orderCancelledSuccess: "주문이 취소되었으며 목록이 업데이트되었습니다",
    orderCancelError: "주문을 취소할 수 없습니다",
  ...
  en: {
    ...
    orderCancelledSuccess: "Order has been cancelled and list updated",
  ...
  vi: {
    ...
    cancel: "Hủy",
    cancelOrder: "Hủy đơn",
    orderCancelledSuccess: "Đơn hàng đã được hủy và danh sách đã được cập nhật",
