...
export const commonTranslations: { [key: string]: CommonTranslations } = {
  ko: {
    ...
    qty: "수량",
    lineTotal: "총계",
    totalBeforeDiscount: "할인 전 총계",
    discountLabel: "할인",
    finalTotal: "최종 총계",
    thankYouAndComeAgain: "감사합니다. 다음에 또 방문해 주세요!",
    returnStatus: "반환 상태",
    phoneNumber: "전화번호",
    noOrders: "주문이 없습니다",
    ...
    invalidFloorData: "유효하지 않은 층 데Am�터",
    urlInput: "URL 입력",
    fileUpload: "파일 업로드",
    selectImageFile: "이미지 파일을 선택하거나",
    dragDropUpload: "드래그엤드롭으로 업로드",
  ...
  en: {
    ...
    thankYouAndComeAgain: "Thank you and come again!",
