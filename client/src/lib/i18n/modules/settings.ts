...
export const settingsTranslations: { [key: string]: SettingsTranslations } = {
  ko: {
    ...
    manageStore: "매장 관리",
    loading: "로딩 중...",
    noStoresYet: "아직 매장이 없습니다",
    clickAddStoreToStart: '"매장 추가" 버튼을 클릭하여 시작하세요',
    ...
    confirmDeleteProductTitle: "제품 삭제 확인",
    confirmDeleteProductDesc: "다음 제품을 삭제하시겠습니까",
    deleteProductWarning: "제품은 주문이나 구매 영수증에 사용되지 않은 경우에만 삭제할 수 있습니다.",
    deleteProductDetails: "이 작업은 취소할 수 없습니다. 제품이 시스템에서 영구적으로 삭제됩니다.",
    deleteProductAction: "제품 삭제",
    ...
    productManagementDesc: "상품 및 서비스 목록 관리",
    ...
    confirmDeleteProductTitle: "제품 삭제 확인",
    confirmDeleteProductDesc: "정말로 제품을 삭제하시겠습니까?",
    deleteProductWarning:
      "경고: 이 작업은 되돌릴 수 없습니다. 제품이 시스템에서 영구적으로 삭제됩니다.",
    deleteProductDetails:
      "이는 이 제품이 포함된 주문 및 보고서에 영향을 줄 것입니다.",
    deleteProductAction: "제품 삭제",
    ...
    // Price list deletion confirmation
    confirmDeletePriceListTitle: "가격표 삭제 확인",
    confirmDeletePriceListDesc: '정말로 가격표 "{name}"을 삭제하시겠습니까?',
    deletePriceListWarning: "이 작업은 되돌릴 수 없습니다.",
    deletePriceListAction: "삭제",

    // Price list management
    priceListManagement: "가격표 관리",
    priceListManagementDesc: "제품 가격표 관리",
    priceLists: "가격표",
    createNewPriceList: "신규 생성",
    editPriceList: "가격표 수정",
    priceListCode: "가격표 코드",
    priceListCodeAutoHint: "(비어 있으면 자동 생성)",
    nextCodeWillBe: "다음 코드:",
    priceListName: "가격표 이름",
    priceListDescription: "설명",
    storesApplied: "적용 매장",
    selectStoresRequired: "적용할 매장을 선택하세요 *",
    canSelectOnlyOneStore: "권한이 있는 매장 1개만 선택할 수 있습니다",
    applyFromDate: "적용 시작일",
    applyToDate: "적용 종료일",
    addProductsToPriceList: "제품 추가",
    exportPriceList: "엑셀 내보내기",
    importPriceList: "엑셀 가져오기",
    productCode: "제품 코드",
    productName: "제품 이름",
    selectPriceListFirst: "가격표를 먼저 선택하세요",
    noProductsInPriceList: "제품이 없습니다",
    selectProductsToAdd: "추가할 제품 선택",
    productsNotInPriceList: "가격표에 없는 제품을 찾을 수 없습니다",
    addProducts: "제품 추가",
    productsCount: "개 상품",
    allProductGroups: "모두",
    searchProductPlaceholder: "코드, 이름 검색",
    searchProductsPlaceholder: "제품 검색...",
    importPricesFromExcel: "엑셀에서 가격 가져오기",
    downloadTemplate: "템플릿 다운로드",
    instructions: "지침",
    downloadExcelTemplate: "엑셀 템플릿 다운로드",
    fillInPrices: "제품 가격 입력",
    selectFileToImport: "가져올 파일 선택",
    excelFile: "엑셀 파일",
    closeDialog: "닫기",
    createPriceList: "가격표 생성",
    updatePriceList: "가격표 업데이트",
    priceListCreatedSuccess: "가격표가 생성되었습니다",
    priceListUpdatedSuccess: "가격표가 업데이트되었습니다",
    priceListDeletedSuccess: "가격표가 삭제되었습니다",
    priceUpdatedSuccess: "가격이 업데이트되었습니다",
    productsAddedSuccess: "제품이 가격표에 추가되었습니다",
    excelExportedSuccess: "엑셀 파일이 내보내기되었습니다",
    excelImportedSuccess: "엑셀 파일이 가져오기되었습니다",
    selectPriceListToExport: "내보낼 가격표를 선택하세요",
    noProductsToExport: "내보낼 제품이 없습니다",
    selectPriceListBeforeImport: "가져오기 전에 가격표를 선택하세요",
    noValidDataToImport: "가져올 유효한 데이터가 없습니다",
    importSuccess: "{successCount}개 가격 가져오기 성공{errorCount} 오류",
    cannotImportExcel: "엑셀 파일을 가져올 수 없습니다",
    priceListCodeAutoGenerated: "코드가 자동으로 생성됩니다 (BG-0000001 형식)",
    enterPriceListName: "가격표 이름을 입력하세요",
    enterPriceListDescription: "가격표 설명을 입력하세요",
    selectAtLeastOneProduct: "최소 1개 제품을 선택하세요",
    addingProducts: "제품 추가 중...",
    savingPriceList: "가격표 저장 중...",
    displayingProducts: "제품 표시 중",
    itemsPerPageLabel: "페이지당 항목 수",
    firstPage: "첫 페이지",
    previousPage: "이전",
    nextPage: "다음",
    lastPage: "마지막 페이지",
    ...
    managedStores: "관리하는 매장 (여러 개 선택 가능)",
    selectManagedStores: "관리할 매장 선택",
    adminRights: "관리자 권한",
    createUser: "생성",
    updateUser: "업데이트",
    ...
    userManagementContent: {
      ...
      permissions: "권한",
      permissionsManagement: "이 사용자의 메뉴 접근 권한 관리",
      userNameRequired: "사용자 이름 *",
      passwordRequired: "비밀번호 *",
      password: "비밀번호",
      enterUsername: "사용자 이름을 입력하세요",
  ...
  en: {
    ...
    clickAddStoreToStart: 'Click "Add Store" button to get started',
    ...
    productManagementDesc: "Manage product and service list",
    ...
    // Price list deletion confirmation
    confirmDeletePriceListTitle: "Confirm Price List Deletion",
    confirmDeletePriceListDesc:
      'Are you sure you want to delete price list "{name}"?',
    deletePriceListWarning: "This action cannot be undone.",
    deletePriceListAction: "Delete",

    // Price list management
    priceListManagement: "Price List Management",
    priceListManagementDesc: "Manage product price lists",
    priceLists: "Price Lists",
    createNewPriceList: "Create New",
    editPriceList: "Edit Price List",
    priceListCode: "Price List Code",
    priceListCodeAutoHint: "(Auto-generated if empty)",
    nextCodeWillBe: "Next code will be:",
    priceListName: "Price List Name",
    priceListDescription: "Description",
    storesApplied: "Stores Applied",
    selectStoresRequired: "Select stores to apply *",
    canSelectOnlyOneStore: "You can only select 1 authorized store",
    applyFromDate: "Apply From Date",
    applyToDate: "Apply To Date",
    addProductsToPriceList: "Add Products",
    exportPriceList: "Export Excel",
    importPriceList: "Import Excel",
    productCode: "Product Code",
    productName: "Product Name",
    selectPriceListFirst: "Please select a price list first",
    noProductsInPriceList: "No products found",
    selectProductsToAdd: "Select products to add to price list",
    productsNotInPriceList: "No products not in price list found",
    addProducts: "Add Products",
    productsCount: "products",
    allProductGroups: "All",
    searchProductPlaceholder: "Search code, name",
    searchProductsPlaceholder: "Search products...",
    importPricesFromExcel: "Import Prices from Excel",
    downloadTemplate: "Download Template",
    instructions: "Instructions",
    downloadExcelTemplate: "Download Excel template",
    fillInPrices: "Fill in product prices",
    selectFileToImport: "Select file to import",
    excelFile: "Excel File",
    closeDialog: "Close",
    createPriceList: "Create Price List",
    updatePriceList: "Update Price List",
    priceListCreatedSuccess: "Price list created successfully",
    priceListUpdatedSuccess: "Price list updated successfully",
    priceListDeletedSuccess: "Price list deleted successfully",
    priceUpdatedSuccess: "Price updated successfully",
    productsAddedSuccess: "Products added to price list successfully",
    excelExportedSuccess: "Excel file exported successfully",
    excelImportedSuccess: "Excel file imported successfully",
    selectPriceListToExport: "Please select a price list to export",
    noProductsToExport: "No products to export",
    selectPriceListBeforeImport: "Please select a price list before importing",
    noValidDataToImport: "No valid data to import",
    importSuccess: "Imported {successCount} prices successfully{errorCount} errors",
    cannotImportExcel: "Cannot import Excel file",
    priceListCodeAutoGenerated: "Code auto-generated in format BG-0000001",
    enterPriceListName: "Enter price list name",
    enterPriceListDescription: "Enter price list description",
    selectAtLeastOneProduct: "Please select at least one product",
    addingProducts: "Adding products...",
    savingPriceList: "Saving price list...",
    displayingProducts: "Displaying products",
    ...
    managedStores: "Managed Stores (can select multiple)",
    selectManagedStores: "Select managed stores",
    ...
    userManagementContent: {
      ...
      permissionsManagement: "Manage menu access permissions for this user",
      userNameRequired: "Username *",
      passwordRequired: "Password *",
      password: "Password",
      ...
      selectManagedStores: "Select stores to manage",
      userCreatedSuccess: "User created successfully",
      userUpdatedSuccess: "User updated successfully",
      userDeletedSuccess: "User deleted successfully",
    ...
    selectAllPriceLists: "Select All",
    categoryIcons: {
      mainDish: "Main Dishes",
      beverages: "Beverages",
      snacks: "Snacks",
  ...
  vi: {
    ...
    loading: "Đang tải...",
    noStoresYet: "Chưa có cửa hàng nào",
    clickAddStoreToStart: 'Nhấn nút "Thêm cửa hàng" để bắt đầu',
    ...
    productManagement: "Quản lý mặt hàng",
    productManagementDesc: "Quản lý danh sách sản phẩm và dịch vụ",
    categoryTitle: "Quản lý nhóm hàng",
    // E-invoice management
    ...
    // Price list deletion confirmation
    confirmDeletePriceListTitle: "Xác nhận xóa bảng giá",
    confirmDeletePriceListDesc:
      'Bạn có chắc chắn muốn xóa bảng giá "{name}" không?',
    deletePriceListWarning: "Hành động này không thể hoàn tác.",
    deletePriceListAction: "Xóa",

    // Price list management
    priceListManagement: "Quản lý bảng giá",
    priceListManagementDesc: "Quản lý bảng giá sản phẩm",
    priceLists: "Bảng giá",
    createNewPriceList: "Tạo mới",
    editPriceList: "Chỉnh sửa bảng giá",
    priceListCode: "Mã bảng giá",
    priceListCodeAutoHint: "(Tự động tạo nếu để trống)",
    nextCodeWillBe: "Mã tiếp theo sẽ là:",
    priceListName: "Tên bảng giá",
    priceListDescription: "Mô tả",
    storesApplied: "Cửa hàng áp dụng",
    selectStoresRequired: "Cửa hàng áp dụng *",
    canSelectOnlyOneStore: "Bạn chỉ có thể chọn 1 chi nhánh được phân quyền",
    applyFromDate: "Áp dụng từ ngày",
    applyToDate: "Đến ngày",
    addProductsToPriceList: "Thêm sản phẩm",
    exportPriceList: "Xuất Excel",
    importPriceList: "Nhập Excel",
    productCode: "Mã hàng",
    productName: "Tên hàng",
    selectPriceListFirst: "Vui lòng chọn bảng giá để xem sản phẩm",
    noProductsInPriceList: "Không tìm thấy sản phẩm",
    selectProductsToAdd: "Chọn sản phẩm thêm vào bảng giá",
    productsNotInPriceList: "Không tìm thấy sản phẩm chưa có trong bảng giá",
    addProducts: "Thêm sản phẩm",
    productsCount: "sản phẩm",
    allProductGroups: "Tất cả",
    searchProductPlaceholder: "Tìm mã, tên hàng",
    searchProductsPlaceholder: "Tìm sản phẩm...",
    importPricesFromExcel: "Nhập giá từ Excel",
    downloadTemplate: "Tải file mẫu",
    instructions: "Hướng dẫn",
    downloadExcelTemplate: "Tải file mẫu Excel",
    fillInPrices: "Điền giá cho các sản phẩm",
    selectFileToImport: "Chọn file để nhập dữ liệu",
    excelFile: "File Excel",
    closeDialog: "Đóng",
    createPriceList: "Tạo bảng giá",
    updatePriceList: "Cập nhật",
    priceListCreatedSuccess: "Tạo bảng giá thành công",
    priceListUpdatedSuccess: "Cập nhật bảng giá thành công",
    priceListDeletedSuccess: "Xóa bảng giá thành công",
    priceUpdatedSuccess: "Cập nhật giá thành công",
    productsAddedSuccess: "Thêm sản phẩm vào bảng giá thành công",
    excelExportedSuccess: "Đã xuất file Excel thành công",
    excelImportedSuccess: "Đã nhập file Excel thành công",
    selectPriceListToExport: "Vui lòng chọn bảng giá để xuất",
    noProductsToExport: "Không có sản phẩm để xuất",
    selectPriceListBeforeImport: "Vui lòng chọn bảng giá trước khi import",
    noValidDataToImport: "Không có dữ liệu hợp lệ để import",
    importSuccess: "Import thành công {successCount} giá{errorCount} lỗi",
    cannotImportExcel: "Không thể import file Excel",
    priceListCodeAutoGenerated: "Mã tự động tạo theo định dạng BG-0000001",
    enterPriceListName: "Vui lòng nhập đầy đủ mã và tên bảng giá",
    enterPriceListDescription: "Nhập mô tả về bảng giá",
    selectAtLeastOneProduct: "Vui lòng chọn ít nhất một sản phẩm",
    addingProducts: "Đang thêm...",
    savingPriceList: "Đang lưu...",
    displayingProducts: "Hiển thị",
    ...
    userNameRequired: "Tên người dùng *",
    password: "Mật khẩu",
    passwordRequired: "Mật khẩu *",
    passwordOptional: "Mật khẩu (tùy chọn)",
    managedStores: "Các cửa hàng được quản lý (có thể chọn nhiều)",
    selectManagedStores: "Chọn các cửa hàng được quản lý",
    adminRights: "Quyền quản trị",
    createUser: "Tạo",
    updateUser: "Cập nhật",
    userCreatedSuccess: "Người dùng đã được tạo thành công",
    userUpdatedSuccess: "Người dùng đã được cập nhật thành công",
    userDeletedSuccess: "Người dùng đã được xóa thành công",
    confirmDeleteUser: "Bạn có chắc chắn muốn xóa người dùng này không?",
    ...
    userManagementContent: {
      ...
      addUser: "Thêm người dùng",
      adminRights: "Quyền quản trị",
      managedStores: "Cửa hàng quản lý",
      permissions: "Phân quyền",
      permissionsManagement: "Quản lý quyền truy cập menu cho người dùng này",
      ...
      selectManagedStores: "Chọn cửa hàng quản lý",
    ...
    selectAllPriceLists: "Chọn tất cả",
  },
};